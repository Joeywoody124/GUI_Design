...
bg-[#121212]  /* Foreground/Black */
bg-[#D02020]  /* Primary Red */
bg-[#1040C0]  /* Primary Blue */
bg-[#F0C020]  /* Primary Yellow */
```

### Essential Component Patterns
```
/* Card */
bg-white border-4 border-black shadow-[8px_8px_0px_0px_black] hover:-translate-y-1 transition-transform duration-200

/* Primary Button */
bg-[#D02020] text-white border-2 border-black shadow-[4px_4px_0px_0px_black] uppercase font-bold tracking-wider active:translate-x-[2px] active:translate-y-[2px] active:shadow-none
